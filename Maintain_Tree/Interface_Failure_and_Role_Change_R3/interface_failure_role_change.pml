...
#define NB_OF_INTERFACES 12 /*Number of interfaces*/
...
init {
  ...
  node_info[4].node_interface[11].interface_type = root
  node_info[4].node_interface[11].potential_aw = 10
  ...
  atomic{
    ...
    run InterfaceSend(3,10);
    run InterfaceReceive(3,10);
