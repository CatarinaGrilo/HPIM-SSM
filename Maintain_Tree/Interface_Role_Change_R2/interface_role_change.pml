...
init {
  ...
  atomic{
    unicastChange(2, 4, non_root);
    unicastChange(2, 6, root);
  }
}
...
ltl ltl_test {(<>([](ROUTER_INTEREST(0)==in && ROUTER_INTEREST(1)==in && ROUTER_INTEREST(2)==in &&
  DOWNSTREAM_INTEREST(0,1)==di && DOWNSTREAM_INTEREST(0,2)==ndi && DOWNSTREAM_INTEREST(1,5)==di && UPSTREAM_INTEREST(2,6)==ui &&
