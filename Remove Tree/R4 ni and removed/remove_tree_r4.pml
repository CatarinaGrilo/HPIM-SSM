...
/*Verification for when the tree contains R4 and then R4 is removed*/
ltl ltl_test {(<>([](ROUTER_INTEREST(0)==ni && ROUTER_INTEREST(1)==ni && ROUTER_INTEREST(2)==ni &&
  DOWNSTREAM_INTEREST(0,1)==ndi && DOWNSTREAM_INTEREST(0,2)==ndi && DOWNSTREAM_INTEREST(1,5)==ndi && DOWNSTREAM_INTEREST(2,6)==ndi &&
  INTERFACE_ASSERT_STATE(0,1)==na && INTERFACE_ASSERT_STATE(0,2)==na && INTERFACE_ASSERT_STATE(1,5)==na && INTERFACE_ASSERT_STATE(2,6)==na)))}
