...
from .PacketProtocolInterest import PacketProtocolJoin, PacketProtocolPrune, PacketNewProtocolJoin, \
    PacketNewProtocolPrune
from .PacketProtocolAssert import PacketProtocolAssert, PacketNewProtocolAssert
...
class PacketNewProtocolHeader(PacketPayload):
    ...
    PIM_MSG_TYPES = {PacketNewProtocolHello.PIM_TYPE: PacketNewProtocolHello,
                     ...
                     PacketNewProtocolAssert.PIM_TYPE: PacketNewProtocolAssert,
                     PacketNewProtocolJoin.PIM_TYPE: PacketNewProtocolJoin,
                     PacketNewProtocolPrune.PIM_TYPE: PacketNewProtocolPrune,
