...
if protocol_globals.MSG_FORMAT == "BINARY":
    ...
    from hpimssm.Packet.PacketProtocolSync import PacketNewProtocolSync as PacketProtocolHelloSync
    ...
    from hpimssm.Packet.PacketProtocolHelloOptions import PacketProtocolHelloHoldtime
...
class Neighbor:
    ...
    def recv_reliable_packet(self, sn, tree, boot_time):
        ...
        if boot_time < self.time_of_boot:
            self.neighbor_logger.debug("SKOL")
            return False
        elif boot_time > self.time_of_boot:
            self.time_of_boot = boot_time
            self.neighbor_snapshot_sn = 0
    ...
    def get_tree_state(self, tree):
        ...
        if self.neighbor_state != Synced:
            ...
            print("is neighbor interested?", self.ip, ":", interest_state)
